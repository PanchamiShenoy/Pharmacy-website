...
<fieldset class="fs">card type<br><input type="radio" name="card" value="visa" checked><img src="images/visa.png" height="18" width="30">VISA
<input type="radio" name="card" value="amex"><img src="images/amex.png" height="18" width="30">Amex
<input type="radio" name="card" value="master"><img src="images/master.png" height="18" width="30">Mastercard<br><br>
